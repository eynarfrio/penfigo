    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <?php echo $this->Form->create('Medico', array('action' => 'registra_medico2')); ?>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo $this->Form->select("Medico.estado", array('En espera' => 'En espera', 'Activo' => 'Activo'), ['class' => 'form-control', 'empty' => 'Seleccione el estado', 'required']) ?>
                            </div>
                        </div>
                    </div>
                </div>
