...
<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview">
            <a href="#">
                <i class="fa fa-wheelchair"></i> <span>Penfigos Ampollas</span>
                <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
                <li><a href="javascript:" onclick="cargarmodal('<?php echo $this->Html->url(array('controller'=>'Penfigoampollas','action' => 'penfigoampolla'));?>');"><i class="fa fa-circle-o"></i>Nuevo</a></li>
