...
class MedicosController extends AppController {
    ...
    public function get_medico() {
        return $this->Medico->findByuser_id($this->Session->read('Auth.User.id'),null,null,0);
    }
    ...
    public function registra_medico() {
        if (!empty($this->request->data['Medico']['upimg']['tmp_name'])) {
            //debug($this->request->data['Medico']['upimg']['tmp_name']);
            $this->request->data['User']['imagen'] = file_get_contents($this->request->data['Medico']['upimg']['tmp_name']);
        }
    ...
    public function ver($idUser = null) {
        ...
        $medico = $this->Medico->findByuser_id($idUser, null, null, 0);
